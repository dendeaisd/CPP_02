...
/*   Updated: 2024/05/12 16:46:11 by fvoicu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void testBsp(const Point& a, const Point& b, const Point& c, const Point& p, const std::string& description) {
    std::cout << "Is point " << description << " inside triangle? "
